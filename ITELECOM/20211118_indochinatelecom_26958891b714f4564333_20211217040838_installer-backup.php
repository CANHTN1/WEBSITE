...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211118_indochinatelecom_26958891b714f4564333_20211217040838_archive.zip';
	const ARCHIVE_SIZE		 = '74861539';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2695889-17040838';
    const SECONDARY_PACKAGE_HASH = 'b39ba57-17040838';
	const VERSION			 = '1.4.3';
